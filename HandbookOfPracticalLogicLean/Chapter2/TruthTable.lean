...
/--
  `gen_all_valuations_as_list_of_list_of_pairs atom_list` := A list of all of the lists of pairs of strings and booleans that can be generated by pairing each atom in `atom_list` with a boolean.
-/
